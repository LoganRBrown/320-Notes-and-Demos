...
public class Buffer
{
    ...
    public void Concat(byte[] newdata, int numOfBytes = -1)
    {
        ...
        for(int i =0; i <newbytes.Length; i++)
        {
            ...
            else
            {
                ...
                if (i - bytes.Length > numOfBytes) break;
            }
        }
    ...
    public void WriteSingleBE(float val, int offset = 0)
    {
        ...
        //WriteByte(parts[0], offset = 1);
        //WriteByte(parts[0], offset = 2);
    ...
    public void WriteString(string str, int offset = 0)
    {
        ...
        WriterChars(chars, offset);

    }

    public void WriterChars(char[] chars, int offset)
    {
